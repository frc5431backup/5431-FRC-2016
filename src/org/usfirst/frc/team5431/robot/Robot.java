...
public class Robot extends IterativeRobot {
    ...
    CANTalon frontright, frontleft, rearright, rearleft;
    ...
    public void teleopPeriodic() {
    	//Robot.DriveBase.frontleft.set(1);
    	//Robot.DriveBase.frontright.set(1);
    	//Robot.DriveBase.rearright.set(1);
        //Scheduler.getInstance().run();
    	this.drive(OI.xbox.getRawAxis(OI.xboxYAxisL), OI.xbox.getRawAxis(OI.xboxYAxisR));
    }
